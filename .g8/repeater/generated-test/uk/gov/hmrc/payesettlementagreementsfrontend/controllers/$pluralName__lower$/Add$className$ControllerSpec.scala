...
import uk.gov.hmrc.payesettlementagreementsfrontend.connectors.FakeDataCacheConnector
...
import uk.gov.hmrc.payesettlementagreementsfrontend.identifiers.$pluralName$Id
...
class Add$className$ControllerSpec extends ControllerSpecBase {
  ...
  def controller(dataRetrievalAction: DataRetrievalAction = getEmptyCacheMap) =
    new Add$className$Controller(frontendAppConfig, messagesApi, FakeDataCacheConnector, new FakeNavigator(desiredRoute = onwardRoute), FakeAuthAction,
